...
const Testimonials = () => {
  ...
  return (
    <section className="py-24 bg-cream dark:bg-secondary relative overflow-hidden [&_.text-secondary-foreground]:text-black dark:[&_.text-secondary-foreground]:text-secondary-foreground [&_.text-secondary-foreground\/70]:text-black/70 dark:[&_.text-secondary-foreground\/70]:text-secondary-foreground/70 [&_.text-secondary-foreground\/60]:text-black/60 dark:[&_.text-secondary-foreground\/60]:text-secondary-foreground/60 [&_.text-secondary-foreground\/30]:text-black/30 dark:[&_.text-secondary-foreground\/30]:text-secondary-foreground/30 [&_.bg-secondary-foreground\/10]:bg-black/10 dark:[&_.bg-secondary-foreground\/10]:bg-secondary-foreground/10">
      {/* Background Elements */}
