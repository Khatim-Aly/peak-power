...
const Testimonials = () => {
  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      rating: 5,
      text: "The quality is exceptional. You can tell this is authentic Himalayan Shilajit. My immunity has improved significantly and I haven't fallen sick in months!",
      avatar: "AP",
    },
    {
      id: 4,
      ...
      rating: 5,
      text: "I was skeptical at first, but the results speak for themselves. My hair is healthier, skin is glowing, and I have energy to spare. Highly recommend!",
      avatar: "SV",
    },
  ];
