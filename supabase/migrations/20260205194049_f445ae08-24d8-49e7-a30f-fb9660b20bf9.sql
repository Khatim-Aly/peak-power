...
CREATE TYPE public.order_status AS ENUM ('placed', 'confirmed', 'dispatched', 'shipped', 'delivered', 'cancelled');
...
-- RLS Policies for products (public read, merchant/admin write)
...
BEGIN
  ...
  -- Assign default role (user) or role from metadata
